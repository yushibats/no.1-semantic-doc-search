...
readonly BACKUP_PARENT="${BACKUP_PARENT:-/u01/aipoc/backups/search-primary-emphasis}"
...
expected_target_hash() {
  case "$1" in
    frontend/index.html) printf '%s' '26c808658faedf494a7f26973a4db914b94235610ad8435168f94f436f6326c9' ;;
    frontend/src/style.css) printf '%s' '93c0db3af57f9a7a726add47d59b19e65f8820d2ad939aebb7d754084c4c3eae' ;;
    *) return 1 ;;
  esac
}
...
echo "[3/5] 主操作を強調した検索画面を反映して本番ビルドしています"
for relative_path in "${DEPLOY_FILES[@]}"; do
...
echo "検索画面の主操作強調をデプロイしました"
echo "バックアップ: ${BACKUP_ROOT}"
echo "ロールバック: sudo bash ${SOURCE_ROOT}/scripts/rollback-search-primary-emphasis.sh ${BACKUP_ROOT}"
